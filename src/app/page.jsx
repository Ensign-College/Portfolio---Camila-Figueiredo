...
import profileIcon from "@/components/ProfileHeader/ProfileIcon/camila1.png";
import SkillsWidget from "@/components/SkillsWidgets/SkillsWidgets";
import htmlIcon from "../components/SkillsWidgets/icons/htm.png";
import cssIcon from "../components/SkillsWidgets/icons/css.png";
import javascriptIcon from "../components/SkillsWidgets/icons/javascript.png";
import javaIcon from "../components/SkillsWidgets/icons/java.png"
...
const skills = [
  { name: "HTML", proficiency: 55, icon: htmlIcon },
  { name: "CSS", proficiency: 45, icon: cssIcon },
  { name: "JavaScript", proficiency: 65, icon: javascriptIcon },
  { name: "java", proficiency: 75, icon: JavaIcon}
];
